...
ft_atoi.o: ft_atoi.c ft_isdigit.c ft_strlen.c ft_strtrim.c ft_strsub.c
	gcc $(FLAGS) -c ft_atoi.c ft_isdigit.c ft_strlen.c ft_strtrim.c ft_strsub.c

ft_bzero.o: ft_bzero.c
	gcc $(FLAGS) -c ft_bzero.c

ft_isalnum.o: ft_isalnum.c ft_isalpha.c ft_isdigit.c
	gcc $(FLAGS) -c ft_isalnum.c ft_isalpha.c ft_isdigit.c
...
ft_memccpy.o: ft_memccpy.c ft_memcpy.c
	gcc $(FLAGS) -c ft_memccpy.c ft_memcpy.c
...
ft_memset.o: ft_memset.c ft_strlen.c
	gcc $(FLAGS) -c ft_memset.c ft_strlen.c
...
ft_putendl.o: ft_putendl.c ft_putchar.c ft_putstr.c
	gcc $(FLAGS) -c ft_putendl.c ft_putchar.c ft_putstr.c
...
ft_strdup.o: ft_strdup.c ft_strlen.c
	gcc $(FLAGS) -c ft_strdup.c ft_strlen.c

ft_strequ.o: ft_strequ.c ft_strcmp.c
	gcc $(FLAGS) -c ft_strequ.c ft_strcmp.c
...
ft_strjoin.o: ft_strjoin.c ft_strlen.c
	gcc $(FLAGS) -c ft_strjoin.c ft_strlen.c

ft_strlcat.o: ft_strlcat.c ft_strlen.c
	gcc $(FLAGS) -c ft_strlcat.c ft_strlen.c

ft_strlen.o: ft_strlen.c
	gcc $(FLAGS) -c ft_strlen.c

ft_strmap.o: ft_strmap.c ft_strlen.c
	gcc $(FLAGS) -c ft_strmap.c ft_strlen.c

ft_strmapi.o: ft_strmapi.c ft_strlen.c
	gcc $(FLAGS) -c ft_strmapi.c ft_strlen.c

ft_strncat.o: ft_strncat.c ft_strlen.c
	gcc $(FLAGS) -c ft_strncat.c ft_strlen.c
...
ft_strnequ.o: ft_strnequ.c ft_strncmp.c
	gcc $(FLAGS) -c ft_strnequ.c ft_strncmp.c

ft_strnew.o: ft_strnew.c
	gcc $(FLAGS) -c ft_strnew.c

ft_strnstr.o: ft_strnstr.c ft_strcmp.c ft_strlen.c ft_strsub.c
	gcc $(FLAGS) -c ft_strnstr.c ft_strcmp.c ft_strlen.c ft_strsub.c

ft_strrchr.o: ft_strrchr.c
	gcc $(FLAGS) -c ft_strrchr.c

ft_strsplit.o: ft_strsplit.c ft_strlen.c ft_strcmp.c
	gcc $(FLAGS) -c ft_strsplit.c ft_strlen.c ft_strcmp.c

ft_strstr.o: ft_strstr.c ft_strcmp.c ft_strlen.c ft_strsub.c
	gcc $(FLAGS) -c ft_strstr.c ft_strcmp.c ft_strlen.c ft_strsub.c

ft_strsub.o: ft_strsub.c
	gcc $(FLAGS) -c ft_strsub.c

ft_strtrim.o: ft_strtrim.c ft_strlen.c ft_strsub.c
	gcc $(FLAGS) -c ft_strtrim.c ft_strlen.c ft_strsub.c
